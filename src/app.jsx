...
export default function App() {
  ...
  const items = [item('Users', '1', <PieChartOutlined />), item('Categories', '2', <DesktopOutlined />), item('Skills', '3', <DesktopOutlined />), item('Services', '4', <DesktopOutlined />)];
    ...
    <AppContext.Provider value={{ data }}>
      <Layout>
        <Sider collapsible collapsed={collapsed} onCollapse={(value) => setCollapsed(value)}>
          ...
          >
            <a href="/">
              <img src="https://images.ctfassets.net/bid9n8mcomvb/sbB7qd2VyI4CMHdXy7W10/3bb80eeb66308b2784c10cd0c0b998c2/Logo_Unitz_OK_2.png?w=40&q=50&h=40" alt="logo" />
            </a>
          </div>
        ...
        <Layout>
          <Content style={{ padding: 24, minHeight: '100vh' }}>
            {key === '1' && <Users />}
            {comps.map((comp) => key === comp.key && <Comp key={comp.key} name={comp.name} />)}
